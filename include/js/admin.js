jQuery(document).ready(function($){
	$('a.add').click(function(){
		...
		imgDetails = '<div class="postbox clone imgbox-'+image_id+'"><div class="handlediv clonedata" title="Click to toggle"><br></div><h3 class="hndle"><span>Image Details</span></h3><div class="inside" style="margin-left: 20px;"><div class="form-field"><label for="cover_image">Slider Image</label><div class="cover_image" style="display:none;"><img src="" name="slider_display_cover_image"  /></div><p><span><i>Best image size : <strong>1330px * 900px</strong> (upload : JPG, PNG & GIF )</i></span></p><input type="hidden" size="36" name="slider_upload_image[]" value="" /><p><input name="slider_upload_image_button" type="button" value="Upload" class="cs_image_issue button button-primary" style="margin-right: 2px;"/><input name="slider_remove_image_button" type="button" value="Remove Image"  width="8%" class="cs_remove_issue button button-primary" style="display:none;"></p></div><label for="Title">Image Title</label><p><input type="text" name="title[]" value=""/></p><label for="Link" style="margin-top:5px;">Image Description</label><p><textarea name="desc[]"></textarea></p><label for="Link" style="margin-top:5px;">Image Link</label><p><input type="text" name="link[]" value=""/></p><p><input type="checkbox" name="linkoption[]"/>Open link in a new window tab</p></div><div class="hr" style="margin-bottom: 10px;"></div><p style="overflow:hidden; padding-right:10px;"><a href="javascript:void(0);" onclick="removebox('+image_id+');" class="btn-right button button-remove button-sm">- Remove</a></p></div>';
		...
		var upload_third_locationlabel = 0;
		 ...
		 $(document.body).on('click.mojoOpenMediaManager', 'input[name="slider_upload_image_button"]', function(e){ //cs_image_issue is the class of our form button
